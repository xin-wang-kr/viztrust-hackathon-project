import autogen
# from autogen.coding.func_with_reqs import Alias, with_requirements
...
with open('data/conv.json', 'r') as file:
    conv_json = json.load(file)
            ...
            chat_results = trust_evaluation_agent.initiate_chats(
                [
                    ...
                    },
                    {
                        ...
                        "message": "Aggregate all feedbacks from social psychologists following the formar: "
